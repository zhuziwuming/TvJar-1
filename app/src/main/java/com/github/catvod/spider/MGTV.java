...
public class MGTV extends Spider {
    ...
    public String categoryContent(String tid, String pg, boolean filter, HashMap<String, String> hashMap) throws Exception {
        try {
            String str3 = "https://pianku.api.mgtv.com/rider/list/msite/v2?platform=msite&channelId=" + tid + "&pn=" + pg + "&chargeInfo=&sort=c2";
            if (hashMap != null) {
            ...
            try {
                ...
                for (int i = 0; i < optJSONArray.length(); i++) {
                    ...
                    String picurl = imgUrl(str3, optJSONObject.optString("img"));
                    String remarks = optJSONObject.optString("updateInfo");
                    if (remarks.equals("")) {
                        remarks = optJSONObject.optString("subtitle");
                    }
