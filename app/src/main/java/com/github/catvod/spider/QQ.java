...
public class QQ extends Spider {
    ...
    private String imgUrl(String str, String str2) {
        String str3;
        try {
            if (str2.startsWith("//")) {
        ...
        try {
            ...
            try {
                ...
                for (int i = 0; i < listItems.size(); i++) {
                    ...
                    String picurl = imgUrl(str4, item.select("img").attr("src"));
    ...
    public String detailContent(List<String> list) throws Exception {
        ...
        try {
            ...
            jSONObject2.put("vod_pic", imgUrl(str, optJSONObject.optString("pic")));
